...
const jsonData = d3.json(urlGoalie);

let goalieStatistics = d3.select("#selDataset");
...
// Grab json data from 'https://2u-data-curriculum-team'
    ...
    d3.json(urlGoalie).then(function(jsonData) {
        ...
        data.forEach(function(element){
            goalieStatistics.append("option").text(element).property("value", element); 
        });
